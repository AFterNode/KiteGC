...
import static net.optifine.Utils.utils.RenderUtil.reAlpha;

public class Button {
    public Module cheat;
    public net.optifine.Gui.MatrixClickGui.Window parent;
    public int x;
    public int y;
    public int index;
    public int remander;
    ...
    CFontRenderer font = FontManager.F16;

    public Button(Module cheat, int x, int y) {
        CFontRenderer font = FontManager.F16;
        CFontRenderer mfont = FontManager.F18;
    ...
    public void render(int mouseX, int mouseY) {
        ...
        if (this.index != 0) {
            ...
            this.y = b2.y + 13 + (b2.expand ? 15 * b2.buttons.size() : 0);
