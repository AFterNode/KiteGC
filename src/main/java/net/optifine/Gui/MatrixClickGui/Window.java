...
//				new Color(255, 255, 255).getRGB(), new Color(255, 255, 255).getRGB());// category
        Gui.drawRect(this.x - 2, this.y, this.x + 92, this.y + 15, RenderUtil.reAlpha(new Color(141, 49, 206).getRGB(), 1.0f));
//        mc.fontRendererObj.drawStringWithShadow(this.category.name(), this.x + 15, this.y + 4, new Color(255, 255, 255).getRGB());
       FontManager.F18.drawString(this.category.name(), this.x + 3, this.y + 3, new Color(241, 237, 237).getRGB());
