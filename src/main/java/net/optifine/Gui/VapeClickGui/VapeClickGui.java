...
//        }
        ...
        if (selectMod == null) {
            FontManager.F18.drawString("Version: "+Client.version.toUpperCase(Locale.ROOT), windowX + 20, windowY + height - 20, new Color(77, 78, 84).getRGB());
        }
        //绘制顶部图标
        ...
        for (Enum<?> e : ClickType.values()) {
            ...
            if (true) {
                if (e == selectType) {
                    if(e == ClickType.Home){
                        FontManager.F30.drawString(Client.name, typeXAnim[i] , windowY+15 , new Color(255, 255, 255).getRGB());
            ...
            if (selectMod == null) {
                ...
                for (ModuleType m : ModuleType.values()) {
                    if (m == modCategory) {
                        ...
                        RenderUtils.drawRoundRect(windowX + 20, hy + FontManager.F18.getStringHeight("") + 2, windowX + 30, hy + FontManager.F18.getStringHeight("") + 4, Client.Theme);
                        if (isHovered(windowX, windowY, windowX + width, windowY + 20, mouseX, mouseY) && Mouse.isButtonDown(0)) {
                            hy = cateY;
                        } else {
                            if (hy != cateY) {
                    ...
                    if (v instanceof Option) {
                        if (valuey + 4 > windowY + 100) {
                            if (((Boolean) v.getValue())) {
                                ...
                                FontManager.F14.drawString(v.getName(), windowX + 445 + valuemodx, valuey + 4, new Color(73, 72, 76).getRGB());
                                v.optionAnim = 0;
...
//                    RenderUtils.drawCircle(windowX + 385 + 10 * m.optionAnimNow / 100 + valuemodx, modY + 7, 3.5, new Color(59, 60, 65).getRGB());
        ...
        if (false) {
            FontManager.F18.drawString("Your Profiles", windowX + 20, windowY + 60, new Color(169, 170, 173).getRGB());
            RenderUtils.drawRoundRect(windowX + 20, windowY + FontManager.F18.getStringHeight("") + 62, windowX + 30, windowY + FontManager.F18.getStringHeight("") + 64, Client.Theme);
            ...
            if (configInputBox.getText().equals("")) {
                FontManager.F16.drawString("Add new profile", windowX + 20, windowY + 97, new Color(63, 64, 67).getRGB());
            }
            RenderUtils.drawCircle(windowX + 100, windowY + 100, 5, Client.Theme);
            RenderUtils.drawCircle(windowX + 100, windowY + 100, 5, Client.Theme);
            FontManager.F20.drawString("+", windowX + 97f, windowY + 95.5f, -1);
            ...
            for (Config c : configs) {
                ...
                FontManager.F16.drawString(c.getName(), cx + 10, cy + 10, -1);
                FontManager.F16.drawString("×", cx + 85, cy + 10, new Color(86, 85, 88).getRGB());
//                RenderUtils.drawImage(cx + 10, cy + 80, 10, 8, new ResourceLocation("Cloud.png"), new Color(91, 92, 98));
                ...
                if (c.equals(Client.config)) {
                    FontManager.F14.drawString("Using", cx + 70, cy + 82, Client.Theme);
                }
