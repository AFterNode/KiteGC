package net.optifine.Gui.VapeClickGui.utils;
...
import static net.optifine.Utils.utils.RenderUtil.drawRoundedRect;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = (int) FontManager.F16.drawString(s1, (float)l, (float)i1, i);
            }
            ...
            {
                j1 = (int) FontManager.F16.drawString(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    FontManager.F16.drawString("_", (float)k1, (float)i1, i);
                }
            }
