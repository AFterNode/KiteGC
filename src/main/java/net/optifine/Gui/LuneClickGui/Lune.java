...
import static net.optifine.Utils.utils.RenderUtils.drawCircle;
import static net.optifine.Utils.utils.RenderUtils.drawImage;
...
public class Lune extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.F30.drawString(Client.real_name, windowX + 15, windowY + 6, new Color(255, 255, 255).getRGB());
        ...
        for (ModuleType mc : ModuleType.values()) {
            ...
            FontManager.F18.drawString(mc.name(), windowX + 25, cateStartY + 5, -1);
            cateStartY += 35;
        }
        GL11.glClear(0);
            ...
            if (m.getCategory() == currentcategory) {
                ...
                if (searchbox.getText().isEmpty()) {
                    if (m.getState()) {
                        ...
                        FontManager.F16.drawString(m.getName(), windowX + 90, realY + 8,
...
//            }
            ...
            for (Value v : currentModul.getValues()) {
                if (v instanceof Mode) {
                    FontManager.F14.drawString(v.getName(), windowX + 210, valueRealY, new Color(204, 204, 204).getRGB());
                    if (isHovered(windowX + windowWeight - 80, valueRealY - 5, windowX + windowWeight - 15,
                        ...
                        FontManager.F14.drawCenteredString(((Mode) v).getModeAsString(),
                    ...
                    FontManager.F14.drawString(v.getName(), windowX + 210, valueRealY - 2,
                    ...
                    FontManager.F14.drawString(v.getName(), windowX + 210, valueRealY - 2,
                            new Color(204, 204, 204).getRGB());
                    FontManager.F14.drawString(v.getValue().toString(),
                            windowX + windowWeight - 15 - 67 + FontManager.F14.getStringWidth(v.getValue().toString())
                                    - FontManager.F14.getStringWidth(v.getValue().toString()),
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (currentModul != null) {
            ...
            FontManager.F16.drawString(currentModul.getName(), windowX + 175, windowY + 50,
                    new Color(50, 50, 50).getRGB());
            FontManager.F14.drawString(currentModul.getName(), windowX + 175, windowY + 58,
                    new Color(191, 191, 191).getRGB());
            if (currentModul.getValues().size() == 0) {
                FontManager.F16.drawString("Empty settings", windowX + 180, windowY + 20, new Color(0, 0, 0).getRGB());
            }
